...
**[rollroyces.github.io/speaksql/demo.html](https://rollroyces.github.io/speaksql/demo.html)** ships four **interactive terminal recordings**
...
are also re-generated by CI on every push from `scripts/record_demo.py`
and published automatically to GitHub Pages by the
